...
Captures generated by `npm run e2e` (desktop 1440×900, mobile 375×812). Regenerate any time — full sets land in `e2e/shots/` (`*-dark.png`, `*-mobile.png`).

| Home — operational cockpit         | Work — runtime spine live          |
| ---------------------------------- | ---------------------------------- |
| ![Home](docs/screenshots/home.png) | ![Work](docs/screenshots/work.png) |

| Build Zone — §38 acceptance checklist     | Approvals — mobile (human decision gate)                   |
| ----------------------------------------- | ---------------------------------------------------------- |
| ![Build Zone](docs/screenshots/build.png) | ![Approvals mobile](docs/screenshots/approvals-mobile.png) |
